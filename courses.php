...
$courselist = array(
  ...
  "weitgeburtsvorbereitung" => initCourse('Weitere Geburtsvorbereitungskurse', 'Geburtsvorbereitung'),
  ...
  "mamaworkoutbauch"=> initCourse('Mamaworkout pränatal', 'Mamaworkout pränatal'),
